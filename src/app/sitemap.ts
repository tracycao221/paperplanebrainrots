...
const routes: Array<{
  ...
  { path: "/wiki", changeFrequency: "weekly", priority: 0.84 },
  { path: "/guide", changeFrequency: "weekly", priority: 0.82 },
  { path: "/guides", changeFrequency: "weekly", priority: 0.8 },
  { path: "/trello", changeFrequency: "weekly", priority: 0.76 },
  { path: "/discord", changeFrequency: "weekly", priority: 0.76 },
